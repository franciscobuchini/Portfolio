...
export default function BentoGrid() {
  ...
  return (
    <main className='BentoGrid'>
      ...
      <Bento Bsv='2' Bsh='4' Bbg='taxbreak' Th='Proximas tareas:' Tp='1) Animación y mods para botones. 2) Investigar patrones y probar backgrounds parallax. 3) Bentos de 8 columnas. 4) Doble capa de imagenes: una opción para que cambie de imagen y otra opción para que una imagen haga zoom y la otra quede fija, ej: background y logo svg. 5) Logo Bento UI' Tpc='white' Tta='center' Tjc='center' />
