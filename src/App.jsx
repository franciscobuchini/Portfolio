...
function App() {
  ...
  const L = {
    english: {
      ...
      Projects_CPH_Tp: "Web app built from scratch to manage walking tour bookings in Copenhagen. I designed and implemented a clean, responsive React and Tailwind CSS frontend with multilingual support. The platform processes over 150 weekly reservations and automates confirmation and follow‑up emails via EmailJS, cutting manual workload by 70%. I also optimized mobile performance. The live app streamlines booking management and delivers a seamless experience for both guides and tourists.",
      Projects_UW_Tp: "Full‑stack online store for underwater hockey apparel, developed from scratch with React, Tailwind CSS, Node.js, and a MongoDB backend. The site handles 800+ monthly orders across 12 countries and integrates personalized email notifications, boosting customer retention. I crafted a minimalist, responsive UI and implemented multi‑language support. Focused on performance and usability, the platform ensures fast load times and an intuitive shopping journey.",
      Projects_SHU_Tp: "Team‑management app for underwater hockey coaches, serving 100+ clubs. I boosted performance and security, cutting load times by 50%, and led UX refinements to raise engagement. Shula App delivers seamless team management, real‑time communication, and athlete performance analytics, increasing adoption and user satisfaction.",
      Projects_BBUI_Tp: "Modular UI framework built from scratch to organize project content into reusable blocks. I designed an intuitive, visually cohesive system that accelerates development by 30% and reduces cognitive load for end users. The responsive interface enhances navigation and accessibility across devices. My goal: deliver a balanced blend of aesthetics and usability without compromising performance.",
      Projects_GGC_Tp: "First web project: a country silhouette guessing game built with pure JavaScript. Users identify maps against the clock and compete based on speed. I implemented HTML, CSS, and JavaScript to deliver a dynamic, interactive, and challenging experience.",
      Projects_RF_Tp: "Interactive website built with Three.js for a fins brand, allowing users to explore and customize a 3D model in real time. I added view controls, dynamic texturing, and smooth animations to enrich interaction and showcase the product.",
      Projects_EM_Tp: "Updated the website of a Wellington, NZ restaurant, optimizing design, content structure, and performance. I improved visual organization, applied basic SEO best practices, and optimized resource loading to enable faster navigation.",
      Projects_CC_Tp: "Website for cafés featuring modular visual and functional blocks designed to highlight menus and promotions. I created a flexible structure that simplifies content updates and enhances visual coherence, improving clarity and user engagement.",
    ...
    spanish: {
      ...
      Projects_CPH_Tp: "Web creada desde cero para gestionar reservas de tours a pie en Copenhague. Implementé un frontend responsive con React y Tailwind CSS y soporte multilenguaje. La plataforma procesa 200 reservas semanales y automatiza correos de confirmación y feedback con EmailJS, reduciendo 80% del trabajo manual. Optimicé usabilidad móvil y estructura de contenido. La app ayuda a guías a mejorar ocupación y satisfacción turística.",
      Projects_UW_Tp: "Tienda online full‑stack de indumentaria para hockey subacuático, desarrollada desde cero. Backend y base de datos gestionan pedidos en 12 países. Usé React y Tailwind CSS para una interfaz minimalista, responsive y multilenguaje. Integré correos automáticos personalizados, elevando la retención de clientes. Centrado en performance y usabilidad, garantiza una experiencia de compra fluida.",
      Projects_SHU_Tp: "App de gestión de equipos para coaches de hockey subacuático, con 100+ clubes registrados. Mejoré rendimiento y seguridad, reduciendo tiempos de carga en 50%. Guié revisiones de UX para aumentar engagement. Shula App ofrece gestión de equipos, comunicación en tiempo real y análisis de rendimiento de atletas.",
      Projects_BBUI_Tp: "Interfaz modular desarrollada desde cero para organizar información y elementos en bloques reutilizables. Su diseño intuitivo y atractivo mejora la navegación, reduce el tiempo de búsqueda en un 25% y facilita el acceso a contenidos. Mi objetivo: optimizar usabilidad y estética sin sacrificar performance ni claridad en la presentación.",
      Projects_GGC_Tp: "Primer proyecto web: juego de siluetas de países creado con JavaScript puro. Los usuarios adivinan mapas contra reloj y compiten por puntuaciones según su rapidez. Implementé HTML, CSS y JavaScript para lograr una experiencia interactiva, dinámica y desafiante.",
      Projects_RF_Tp: "Sitio interactivo con Three.js para una marca de aletas, donde el usuario explora y personaliza un modelo 3D en tiempo real. Añadí controles de vista, texturizado dinámico y animaciones suaves para enriquecer la interacción y destacar el producto.",
      Projects_EM_Tp: "Actualicé el sitio de un restaurante en Wellington, NZ, optimizando diseño, estructura de contenido y rendimiento. Mejore la organización visual, implementé prácticas SEO básicas y optimicé la carga de recursos para ofrecer una navegación más ágil.",  
      Projects_CC_Tp: "Sitio web para cafeterías con bloques visuales y funcionales, diseñado para resaltar menús y promociones. Creé una estructura modular que facilita la actualización de contenidos y mejora la coherencia visual, aportando flexibilidad y claridad al usuario.",
  ...
  return (
    <>
      ...
      <Bento Bv="4" Bh="4" Bs="BR1" Th4="Shula App" Limg={Limg_SHU} IBimg={IBimg_SHU} IFimg={IFimg_SHU} Tp={L[Lang].Projects_SHU_Tp} Com={Button} Bt={L[Lang].Visit}  Lurl="https://www.shula.app/" />
      ...
      <Bento Bv="5" Bh="4" Bs="BL1" Th4="Bento Box UI" Limg={Limg_BBUI} IBimg={IBimg_BBUI} IFimg={IFimg_BBUI} Tp={L[Lang].Projects_BBUI_Tp} Com={Button} Bt={L[Lang].Visit}  Lurl="https://bentoboxui.vercel.app" />
      <Bento Bv="4" Bh="4" Bs="BL1" Th4="Café Café" Limg={Limg_CC} IBimg={IBimg_CC} IFimg={IFimg_CC} Tp={L[Lang].Projects_CC_Tp} Com={Button} Bt={L[Lang].Visit} Lurl="https://cafe-cafe.vercel.app"/>
      <Bento Bv="4" Bh="4" Bs="BL1" Th4="El Matador" Limg={Limg_EM} IBimg={IBimg_EM} IFimg={IFimg_EM} Tp={L[Lang].Projects_EM_Tp} Com={Button} Bt={L[Lang].Visit} Lurl="https://el-matador-website.netlify.app/"/>
